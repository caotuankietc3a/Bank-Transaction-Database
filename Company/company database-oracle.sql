...
CREATE TABLE Works_on (
    ...
    FOREIGN KEY(Pno) REFERENCES project(Pnumber) ON DELETE SET NULL,
...
-- INSERT INTO Employee VALUES ('John', 'B', 'Smith', '123456788', TO_DATE('01-09-1965', 'dd-mm-yyyy'), '731 Fondren, Houston, TX', 'M', 30000, null, null);
